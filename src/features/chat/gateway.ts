...
export type MessageGatewayEvent = MessageCreateEvent | MessageUpdateEvent | MessageDeleteEvent;
...
const requestedIntents = GatewayIntent.GUILDS | GatewayIntent.GUILD_MESSAGES | GatewayIntent.MESSAGE_CONTENT;
